...
TODO
1. Продумать нужно ли вместо выдачи ощибки о несуществующем пользователе создавать его
2. Принимать последними аргументами список xml которые нужно использовать, если не задан, использовать все
3. Сделать скрипт `uninstall.sh user_name`, который корректно удаляет пулы и виртуальные машины пользователя `user_name`
