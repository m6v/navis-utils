...
└── noVNC-1.6.0/           # Изолированный каталог оригинального noVNC, с удалением неиспользуемых файлов
    ├── vnc.html           # Базовая веб-страница экрана, которую загружает ваш iframe
...
# Отличие новой версии от старой, основанной на novnc и websockify из extended репозитория Astra Linux
