1. В скрипте найти пользователя с uid=1000 и выводить его как дефолтного!
2. Удалять только пользователей группы leagners после предварительной проверки отсутствия пула дисков
