...
2. Доделать роль для установки на АРМ инструктора панели с веб-интерфейсом виртуальных машин обучаемых (копирование deb-пакетов для novnc, установка novnc, копирование сервера, файла токенов, службы запуска сервера)
